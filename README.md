...
*Порядок команд* в таком случае (`LEFT,ACT` или `ACT,LEFT`) - *имеет значение*: в первом случае сначала двигаемся, потом ставим бомбу на новой точке. Во втором случае сначала ставим бомбу на старой точке, потом двигаемся. 
